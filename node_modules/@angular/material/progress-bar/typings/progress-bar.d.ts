...
export declare class MatProgressBar extends _MatProgressBarMixinBase implements CanColor, AfterViewInit, OnDestroy {
    ...
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<MatProgressBar, "mat-progress-bar", ["matProgressBar"], { 'color': "color", 'mode': "mode", 'value': "value", 'bufferValue': "bufferValue" }, { 'animationEnd': "animationEnd" }, never>;
}
export {};
