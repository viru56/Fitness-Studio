...
export declare class MatMenuTrigger implements AfterContentInit, OnDestroy {
    ...
    private _getPortal;
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<MatMenuTrigger, "[mat-menu-trigger-for], [matMenuTriggerFor]", ["matMenuTrigger"], { 'restoreFocus': "matMenuTriggerRestoreFocus", '_deprecatedMatMenuTriggerFor': "mat-menu-trigger-for", 'menu': "matMenuTriggerFor", 'menuData': "matMenuTriggerData" }, { 'menuOpened': "menuOpened", 'onMenuOpen': "onMenuOpen", 'menuClosed': "menuClosed", 'onMenuClose': "onMenuClose" }, never>;
}
