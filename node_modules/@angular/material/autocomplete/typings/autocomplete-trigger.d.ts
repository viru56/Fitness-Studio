...
export declare class MatAutocompleteTrigger implements ControlValueAccessor, AfterViewInit, OnChanges, OnDestroy {
    ...
    private _canOpen;
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<MatAutocompleteTrigger, "input[matAutocomplete], textarea[matAutocomplete]", ["matAutocompleteTrigger"], { 'position': "matAutocompletePosition", 'autocompleteAttribute': "autocomplete", 'autocompleteDisabled': "matAutocompleteDisabled", 'autocomplete': "matAutocomplete", 'connectedTo': "matAutocompleteConnectedTo" }, {}, never>;
}
