...
export declare class MatTooltip implements OnDestroy, OnInit {
    ...
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<MatTooltip, "[matTooltip]", ["matTooltip"], { 'showDelay': "matTooltipShowDelay", 'hideDelay': "matTooltipHideDelay", 'position': "matTooltipPosition", 'disabled': "matTooltipDisabled", 'message': "matTooltip", 'tooltipClass': "matTooltipClass" }, {}, never>;
}
...
export declare class TooltipComponent implements OnDestroy {
     ...
     */
    _markForCheck(): void;
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<TooltipComponent, "mat-tooltip-component", never, {}, {}, never>;
}
