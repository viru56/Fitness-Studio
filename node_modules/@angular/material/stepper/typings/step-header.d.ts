...
export declare class MatStepHeader extends CdkStepHeader implements OnDestroy {
    ...
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<MatStepHeader, "mat-step-header", never, { 'state': "state", 'label': "label", 'errorMessage': "errorMessage", 'iconOverrides': "iconOverrides", 'index': "index", 'selected': "selected", 'active': "active", 'optional': "optional", 'disableRipple': "disableRipple" }, {}, never>;
}
