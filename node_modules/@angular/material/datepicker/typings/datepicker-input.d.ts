...
export declare class MatDatepickerInput<D> implements ControlValueAccessor, OnDestroy, Validator {
    ...
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<MatDatepickerInput<any>, "input[matDatepicker]", ["matDatepickerInput"], { 'value': "value", 'matDatepicker': "matDatepicker", 'matDatepickerFilter': "matDatepickerFilter", 'min': "min", 'max': "max", 'disabled': "disabled" }, { 'dateChange': "dateChange", 'dateInput': "dateInput" }, never>;
}
