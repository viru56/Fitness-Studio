...
export declare class MatPaginator extends _MatPaginatorBase implements OnInit, OnDestroy, CanDisable, HasInitialized {
    ...
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<MatPaginator, "mat-paginator", ["matPaginator"], { 'disabled': "disabled", 'pageIndex': "pageIndex", 'length': "length", 'pageSize': "pageSize", 'pageSizeOptions': "pageSizeOptions", 'hidePageSize': "hidePageSize", 'showFirstLastButtons': "showFirstLastButtons", 'color': "color" }, { 'page': "page" }, never>;
}
export {};
