...
export declare class MatButtonToggle extends _MatButtonToggleMixinBase implements OnInit, CanDisableRipple, OnDestroy {
     ...
     */
    _markForCheck(): void;
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<MatButtonToggle, "mat-button-toggle", ["matButtonToggle"], { 'disableRipple': "disableRipple", 'ariaLabelledby': "aria-labelledby", 'tabIndex': "tabIndex", 'appearance': "appearance", 'checked': "checked", 'disabled': "disabled", 'id': "id", 'name': "name", 'ariaLabel': "aria-label", 'value': "value" }, { 'change': "change" }, never>;
}
export {};
