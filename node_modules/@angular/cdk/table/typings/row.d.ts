...
export declare class CdkHeaderRowDef extends _CdkHeaderRowDefBase implements CanStick, OnChanges {
    ...
    ngOnChanges(changes: SimpleChanges): void;
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<CdkHeaderRowDef, "[cdkHeaderRowDef]", never, { 'columns': "cdkHeaderRowDef", 'sticky': "cdkHeaderRowDefSticky" }, {}, never>;
}
/** @docs-private */
...
export declare class CdkFooterRowDef extends _CdkFooterRowDefBase implements CanStick, OnChanges {
    constructor(template: TemplateRef<any>, _differs: IterableDiffers);
    ngOnChanges(changes: SimpleChanges): void;
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<CdkFooterRowDef, "[cdkFooterRowDef]", never, { 'columns': "cdkFooterRowDef", 'sticky': "cdkFooterRowDefSticky" }, {}, never>;
}
/**
...
export declare class CdkRowDef<T> extends BaseRowDef {
    ...
    constructor(template: TemplateRef<any>, _differs: IterableDiffers);
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<CdkRowDef<any>, "[cdkRowDef]", never, { 'columns': "cdkRowDefColumns", 'when': "cdkRowDefWhen" }, {}, never>;
}
...
export declare class CdkCellOutlet implements OnDestroy {
    ...
    ngOnDestroy(): void;
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<CdkCellOutlet, "[cdkCellOutlet]", never, {}, {}, never>;
}
/** Header template container that contains the cell outlet. Adds the right class and role. */
export declare class CdkHeaderRow {
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<CdkHeaderRow, "cdk-header-row, tr[cdk-header-row]", never, {}, {}, never>;
}
/** Footer template container that contains the cell outlet. Adds the right class and role. */
export declare class CdkFooterRow {
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<CdkFooterRow, "cdk-footer-row, tr[cdk-footer-row]", never, {}, {}, never>;
}
/** Data row template container that contains the cell outlet. Adds the right class and role. */
export declare class CdkRow {
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<CdkRow, "cdk-row, tr[cdk-row]", never, {}, {}, never>;
}
export {};
