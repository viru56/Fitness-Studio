...
export declare class CdkTextColumn<T> implements OnDestroy, OnInit {
    ...
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<CdkTextColumn<any>, "cdk-text-column", never, { 'justify': "justify", 'name': "name", 'headerText': "headerText", 'dataAccessor': "dataAccessor" }, {}, never>;
}
