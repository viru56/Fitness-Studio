...
export declare class MutationObserverFactory {
    ...
    static ngInjectableDef: ɵngcc0.ɵɵInjectableDef<MutationObserverFactory>;
}
...
export declare class ContentObserver implements OnDestroy {
    ...
    static ngInjectableDef: ɵngcc0.ɵɵInjectableDef<ContentObserver>;
}
/**
...
export declare class CdkObserveContent implements AfterContentInit, OnDestroy {
    ...
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<CdkObserveContent, "[cdkObserveContent]", ["cdkObserveContent"], { 'disabled': "cdkObserveContentDisabled", 'debounce': "debounce" }, { 'event': "cdkObserveContent" }, never>;
}
export declare class ObserversModule {
    static ngModuleDef: ɵngcc0.ɵɵNgModuleDefWithMeta<ObserversModule, [typeof CdkObserveContent], never, [typeof CdkObserveContent]>;
    static ngInjectorDef: ɵngcc0.ɵɵInjectorDef<ObserversModule>;
}
