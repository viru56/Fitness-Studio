...
export declare class AutofillMonitor implements OnDestroy {
    ...
    ngOnDestroy(): void;
    static ngInjectableDef: ɵngcc0.ɵɵInjectableDef<AutofillMonitor>;
}
...
export declare class CdkAutofill implements OnDestroy, OnInit {
    ...
    ngOnInit(): void;
    ngOnDestroy(): void;
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<CdkAutofill, "[cdkAutofill]", never, {}, { 'cdkAutofill': "cdkAutofill" }, never>;
}
